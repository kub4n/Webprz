            ...
            <div class="box box-primary">
                <div class="box-body">
                    <data-tables :data="data" :actions-def="actionsDef">
                        ...
                        <el-table-column prop="name" :label="trans('categories.name')">
                        </el-table-column>
    ...
    export default {
        data() {
            return {
                ...
                actionsDef: {
                    def: [{
                        name: this.trans('categories.create-category'),
                        icon: 'edit',
                        handler: () => {
                            this.$router.push({name: 'admin.blog.category.create'});
                        },
                    }],
                },
            };
        ...
        methods: {
            fetchData() {
                axios.get(route('api.blog.category.index'))
                    .then((response) => {
